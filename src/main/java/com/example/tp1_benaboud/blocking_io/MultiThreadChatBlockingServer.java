package com.example.tp1_benaboud.blocking_io;
...
public class MultiThreadChatBlockingServer extends Thread {
	private List<Conversation>conversations=new ArrayList<>();
	int clientsCount;
	
	public static void main(String[] args) {
		new MultiThreadChatBlockingServer().start();
	}
	
	public void run() {
		System.out.println("The server is started using port = 1996");
		try{
